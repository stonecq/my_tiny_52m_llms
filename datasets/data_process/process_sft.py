...
def process_line(line):
    try:
        ...
        a_ids = tokenizer.encode(item['answer'], add_special_tokens=False)
        # 拼接
        full_ids = q_ids + [tokenizer.special_tokens['<bos>']] + a_ids + [tokenizer.special_tokens['<eos>']]
        return full_ids
    except:
        return None
...
if __name__ == "__main__":
    preprocess_to_pickle("/llama/datasets/tiny_llms/sft_train/sft_data.jsonl",
                         "/llama/datasets/tiny_llms/sft_train/sft_data.pkl")